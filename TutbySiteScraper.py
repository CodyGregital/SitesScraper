...
class TutbySiteScraper(SiteScraper):
    ...
    def get_articles(self):
        ...
        tags_with_links = header_link + topnews_links + geo_news_links + exclusive_news_links + \
                 economics_news_links + press_news_links + society_news_links + world_news_links + \
                 ...
                 partner_news_links + popcorn_news_links
    ...
    def get_article(self, urls):
        ...
        for i, link in enumerate(urls):
            ...
            article_title = ' '.join(article_soup.find('div', {'class': 'm_header'}).find('h1').text.split())
            # print('Title = ', article_title)

            article_text = self.get_edit_article_text(article_soup.find('div', attrs={'id': 'article_body'}))
